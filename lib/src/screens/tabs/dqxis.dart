...
class Dqxis extends StatelessWidget {
  const Dqxis(this.audio, {Key? key}) : super(key: key);
  final Audio audio;
        ...
        child: Scrollbar(
          child: ListView(
            ...
            children: <Widget>[
              ...
              Button(
                  audio, 'voices/DQXIS/kajinoomoroiyan.mp3', 'カジノおもろいやんやろややろや'),
              ...
              Button(audio, 'voices/DQXIS/rippanayuusha.mp3', '立派な勇者の役目（スロカス）'),
